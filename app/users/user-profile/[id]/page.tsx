        ...
        <div className="flex flex-col sm:flex-row gap-8 items-start">
          ...
          <div className="flex flex-col items-center gap-2 min-w-[140px]">
            {profilePic ? (
              ...
              <div className="w-32 h-32 rounded-full border-4 border-blue-200 flex items-center justify-center bg-gray-100 text-gray-500 text-center text-sm font-medium">
                Profile Preview
              </div>
            )}
            <button
